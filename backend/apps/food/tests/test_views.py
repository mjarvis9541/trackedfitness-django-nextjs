...
class FoodListAPIViewTestCase(TokenAPITestCase):
    @classmethod
...
class FoodDetailAPIViewTestCase(TokenAPITestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
        cls.brand = BrandFactory(
        ...
        cls.food_b = FoodFactory(
            brand=cls.brand,
            created_by=cls.user_b,
            updated_by=cls.user_b,
        )
        cls.valid_data = {
            "name": "test food update",
            "slug": "test-food-update",
            "brand": cls.brand.pk,
            # "data_value": 100,
            # "data_measurement": "g",
            "serving": "100g",
        ...
        cls.url = reverse("food-detail", kwargs={"pk": cls.food.pk})
        cls.other_user_obj_url = reverse("food-detail", kwargs={"pk": cls.food_b.pk})
